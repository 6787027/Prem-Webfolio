...
export default function AboutMePage() {
  ...
  return (
    <div className="bg-gray-950 text-white min-h-dvh flex flex-col">
      ...
      <main className="w-full p-6 md:px-16 lg:px-24">
        <section className="mb-12">
          <h1 className="font-bold text-5xl mb-4 text-orange-400">Get to know me...</h1>
          <p className="w-full md:w-3/4 lg:w-2/3 text-lg text-gray-200 leading-relaxed">
